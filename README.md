...
Because [why not](https://microprediction.github.io/timemachines/why) do things in **walk-forward incremental** fashion with **one line of code**? Here y is a vector or scalar, and we want to predict y[0] (or y if scalar) k=3 steps in advance.
