...
Use popular forecasting packages with one line of code (or brows their [Elo ratings](https://microprediction.github.io/timeseries-elo-ratings/html_leaderboards/univariate-k_003.html)).
...
What's different:
   ...
   - **Simple fast accurate alternatives** to popular time series packages (for example [thinking](https://github.com/microprediction/timemachines/blob/main/timemachines/skaters/simple/thinking.py) skaters perform well in the [Elo ratings](https://microprediction.github.io/timeseries-elo-ratings/html_leaderboards/univariate-k_003.html)) and better than the brand names. See the  [article](https://www.microprediction.com/blog/timemachines) comparing "thinking" to both Facebook prophet and Neural Prophet.
