...
Because [why not](https://microprediction.github.io/timemachines/why) do things in walk-forward fashion with **one line of code**? Here y is a vector or scalar, and we want to predict it three k=3 steps in advance.
