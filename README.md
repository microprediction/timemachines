...
## Fast, incremental, constantly improving, incrementally evaluated, autonomous, univariate (mostly) time-series prediction algorithms in a common simple, stateless, functional, "sequence-to-sequence" signature. 
