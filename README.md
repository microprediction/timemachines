...
## Fast, incremental, constantly improving, incrementally evaluated, autonomous time-series prediction algorithms in a simple, functional, stateless "sequence-to-sequence" format. 
