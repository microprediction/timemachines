...
def ratings_url(k:int, category='univariate'):
    url_template = 'https://raw.githubusercontent.com/microprediction/timeseries-elo-ratings/main/ratings/TYPE-k_KKK.json'
    kkk = str(k).zfill(3)
    return url_template.replace('KKK',kkk).replace('TYPE', category)
