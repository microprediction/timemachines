...
if using_statsmodels:
    ...
    from timemachines.skaters.tsa.tsaconstant import TSA_D0_SKATERS, TSA_CONSTANT_SKATERS
    ...
    def tsa_precision_combined_ensemble(y :Y_TYPE, s:dict, k:int =1, a:A_TYPE =None, t:T_TYPE =None, e:E_TYPE =None)->([float] , Any , Any):
        return precision_weighted_ensemble_factory(fs=TSA_THETA_SKATERS+TSA_CONSTANT_SKATERS,y=y,s=s,k=k,a=a,t=t,e=e,r=R_PRECISION)


    def tsa_balanced_combined_ensemble(y :Y_TYPE, s:dict, k:int =1, a:A_TYPE =None, t:T_TYPE =None, e:E_TYPE =None)->([float] , Any , Any):
        return precision_weighted_ensemble_factory(fs=TSA_THETA_SKATERS+TSA_CONSTANT_SKATERS,y=y,s=s,k=k,a=a,t=t,e=e,r=R_BALANCED)


    def tsa_aggressive_combined_ensemble(y :Y_TYPE, s:dict, k:int =1, a:A_TYPE =None, t:T_TYPE =None, e:E_TYPE =None)->([float] , Any , Any):
        return precision_weighted_ensemble_factory(fs=TSA_THETA_SKATERS+TSA_CONSTANT_SKATERS,y=y,s=s,k=k,a=a,t=t,e=e,r=R_AGGRESSIVE)
    ...
    TSA_DO_ENSEMBLE_SKATERS = []
    TSA_THETA_ENSEMBLE_SKATERS = []
