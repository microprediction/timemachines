...
if using_ik:
    from timemachines.skaters.ik.ikwrappers import ik_nnma_iskater
    ...
    def ik_nn_ma3(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = float, e: E_TYPE = None, r: R_TYPE = float, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=1/3, emp_mass=emp_mass,
    ...
    def ik_nn_ma10(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = float, e: E_TYPE = None, r: R_TYPE = float, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=1/10, emp_mass=emp_mass,
                                    iskater=ik_nnma_iskater,
                                    iskater_kwargs={},
                                    min_e=0)

    def ik_nn_ma100(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = float, e: E_TYPE = None, r: R_TYPE = float, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=1/100, emp_mass=emp_mass,
                                    iskater=ik_nnma_iskater,
                                    iskater_kwargs={},
                                    min_e=0)
...
if __name__=='__main__':
    ...
    err1 = hospital_mean_square_error_with_sporadic_fit(f=ik_nnma_iskater, k=3, n=110)