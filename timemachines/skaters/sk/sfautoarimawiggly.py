...
if using_statsforecast:
    ...
    def sf_autoarima_wiggly_factory(y: Y_TYPE, s: dict, k: int, a: A_TYPE = None, t: T_TYPE = None,
...
SF_AUTOARIMA_WIGGLY_SKATERS = [ sf_autoarima_wiggly_d010_m1, sf_autoarima_wiggly_d010_m2,
