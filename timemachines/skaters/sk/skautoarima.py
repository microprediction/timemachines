...
if using_sktime:
    from timemachines.skaters.sk.skwrappers import sk_autoarima_hourly_iskater
    ...
    def sk_autoarima(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r: R_TYPE = None, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=r, emp_mass=emp_mass,
                                    iskater=sk_autoarima_hourly_iskater,
                                    iskater_kwargs={},
                                    min_e=0)

    SK_AA_SKATERS = [batch_skater_factory]
...
if __name__=='__main__':
    ...
    err1 = hospital_mean_square_error(f=sk_autoarima, k=3, n=30)
