...
def fbprophet_exogenous_r2(y: Y_TYPE, s: dict, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r:R_TYPE=0.0):
...
def fbprophet_recursive_r2(y: Y_TYPE, s: dict, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r:R_TYPE=0.0):
    """ Same as exogenous, but uses prophet to predict y[1:]  """
    param_names = ['changepoint_prior_scale', 'seasonality_prior_scale']
    return fbprophet_hyperparam_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=r, param_names=param_names, recursive=True)


def fbprophet_known_r2(y: Y_TYPE, s: dict, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r:R_TYPE=0.0):
    """ Uses known-in-advance but not y[1:] """
    y0 = [wrap(y)[0]]
    param_names = ['changepoint_prior_scale', 'seasonality_prior_scale']
...
def fbprophet_univariate_r2(y: Y_TYPE, s: dict, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None):
    """ Simple univariate prediction using only y[0], and not 'a' or y[1:] """
    y0 = [wrap(y)[0]]
    param_names = ['changepoint_prior_scale', 'seasonality_prior_scale']
    return fbprophet_hyperparam_skater_factory(y=y0, s=s, k=k, a=None, t=t, e=e, param_names=param_names, recursive=False)
