...
if using_kats:
    ...
    def kats_holt_winters(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r: R_TYPE = None, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=r, emp_mass=emp_mass,
                                    iskater=kats_HoltWinters_iskater,
                                    iskater_kwargs={},
                                    min_e=0)

    KATS_HOLT_WINTERS_SKATERS = [kats_holt_winters]

else:
    KATS_HOLT_WINTERS_SKATERS = []

if __name__=='__main__':
    from timemachines.skatertools.evaluation.evaluators import hospital_mean_square_error_with_sporadic_fit
    err1 = hospital_mean_square_error_with_sporadic_fit(f=kats_HoltWinters_iskater, k=3, n=110)