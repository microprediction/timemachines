...
if using_darts:
    from timemachines.skaters.darts.dartswrappers import darts_ExponentialSmoothing_iskater
    ...
    def darts_ExponentialSmoothing_skater(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r: R_TYPE = None, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=r, emp_mass=emp_mass,
                                    iskater=darts_ExponentialSmoothing_iskater,
                                    iskater_kwargs={},
                                    min_e=0)

    DARTS_EXPONENTIALSMOOTHING_SKATERS = [darts_ExponentialSmoothing_iskater]
