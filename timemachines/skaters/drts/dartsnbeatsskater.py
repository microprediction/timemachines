...
if using_darts:
    from timemachines.skaters.drts.dartswrappers import darts_NBEATS_iskater
    ...
    def darts_nbeats(y: Y_TYPE, s, k: int, a: A_TYPE = None, t: T_TYPE = None, e: E_TYPE = None, r: R_TYPE = None, emp_mass=0.0):
        return batch_skater_factory(y=y, s=s, k=k, a=a, t=t, e=e, r=r, emp_mass=emp_mass,
                                    iskater=darts_NBEATS_iskater,
                                    iskater_kwargs={},
                                    min_e=0)
...
if __name__=='__main__':
    ...
    err1 = hospital_mean_square_error_with_sporadic_fit(f=darts_NBEATS_iskater, k=3, n=110)